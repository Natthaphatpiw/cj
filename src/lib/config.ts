...
const serverSchema = z.object({
  ...
  OPENAI_CHECKIN_MODEL: z.string().default("gpt-4.1-mini"),
  ...
  ENABLE_DAILY_OPEN_CHECKIN: trueFalse.default(false),
  DAILY_CHECKIN_MAX_USERS_PER_RUN: z.coerce.number().int().positive().max(5000).default(500),
  DAILY_CHECKIN_MIN_INACTIVITY_HOURS: z.coerce.number().int().positive().max(168).default(20),
  DAILY_CHECKIN_MIN_GAP_HOURS: z.coerce.number().int().positive().max(168).default(20),
